...
import Fixturedb from "../../../data/EdsFixtureDb.json";
const EDSAllCompetition = () => {
  return (
    <>
      <FixtureTabContent>
        <FixtureTabContentTop>
        ...
        {Fixturedb["AUGUST 2024"].map((fixture, index) => (
          <FixtureTabContentBottom key={fixture.id}>
            ...
            <TicketSection>
              ...
              {fixture.Ticket === "Coming soon" ||
              fixture.Ticket === "No tickets available" ? null : (
...
export default EDSAllCompetition;
