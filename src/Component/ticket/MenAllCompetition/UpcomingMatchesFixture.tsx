...
import Fixturedb from "../../../data/FixturesDb.json";
const UpcomingMatchesFixture = () => {
  return (
    <>
      {Fixturedb["July 2024"].map((fixture, index) => (
        <FixtureTabContent key={fixture.id}>
          <FixtureTabContentTop>
            <DateInfo>{fixture.Title}</DateInfo>
          </FixtureTabContentTop>
          <FixtureTabContentBottom>
            <FixtureTabContentBottomInfoText>
              <FixtureTabContentBottomInfoLogo
      ...
      <FixtureTabContent>
        <FixtureTabContentTop>
          <DateInfo>AUGUST 2024</DateInfo>
        </FixtureTabContentTop>
        {Fixturedb["August 2024"].map((fixture, index) => (
      ...
      <FixtureTabContent>
        ...
        {Fixturedb["SEPTEMBER 2024"].map((fixture, index) => (
          <FixtureTabContentBottom key={fixture.id}>
            <FixtureTabContentBottomInfoText>
              <FixtureTabContentBottomInfoLogo
                logo={fixture.typelogo}
      ...
      <FixtureTabContent>
        ...
        {Fixturedb["OCTOBER 2024"].map((fixture, index) => (
          <FixtureTabContentBottom key={fixture.id}>
            <FixtureTabContentBottomInfoText>
              <FixtureTabContentBottomInfoLogo
                logo={fixture.typelogo}
      ...
      <FixtureTabContent>
        ...
        {Fixturedb["NOVEMBER 2024"].map((fixture, index) => (
          <FixtureTabContentBottom key={fixture.id}>
            <FixtureTabContentBottomInfoText>
              <FixtureTabContentBottomInfoLogo
                logo={fixture.typelogo}
      ...
      <FixtureTabContent>
        ...
        {Fixturedb["DECEMBER 2024"].map((fixture, index) => (
          <FixtureTabContentBottom key={fixture.id}>
            <FixtureTabContentBottomInfoText>
              <FixtureTabContentBottomInfoLogo
                logo={fixture.typelogo}
      ...
      <FixtureTabContent>
        ...
        {Fixturedb["JANUARY 2025"].map((fixture, index) => (
          <FixtureTabContentBottom key={fixture.id}>
            <FixtureTabContentBottomInfoText>
              <FixtureTabContentBottomInfoLogo
                logo={fixture.typelogo}
      ...
      <FixtureTabContent>
        <FixtureTabContentTop>
          <DateInfo>FEBRUARY 2025</DateInfo>
        </FixtureTabContentTop>
        {Fixturedb["FEBRUARY 2025"].map((fixture, index) => (
          <FixtureTabContentBottom key={fixture.id}>
            <FixtureTabContentBottomInfoText>
              <FixtureTabContentBottomInfoLogo
                logo={fixture.typelogo}
      ...
      <FixtureTabContent>
        ...
        {Fixturedb["MARCH 2025"].map((fixture, index) => (
          <FixtureTabContentBottom key={fixture.id}>
            <FixtureTabContentBottomInfoText>
              <FixtureTabContentBottomInfoLogo
                logo={fixture.typelogo}
      ...
      <FixtureTabContent>
        ...
        {Fixturedb["APRIL 2025"].map((fixture, index) => (
          <FixtureTabContentBottom key={fixture.id}>
            <FixtureTabContentBottomInfoText>
              <FixtureTabContentBottomInfoLogo
                logo={fixture.typelogo}
      ...
      <FixtureTabContent>
        ...
        {Fixturedb["MAY 2025"].map((fixture, index) => (
          <FixtureTabContentBottom key={fixture.id}>
            <FixtureTabContentBottomInfoText>
              <FixtureTabContentBottomInfoLogo
                logo={fixture.typelogo}
...
export default UpcomingMatchesFixture;
