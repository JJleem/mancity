...
const MenPremierLeagueHome = () => {
  return (
    <>
      {Fixturedb["July 2024"]
        .filter((fixture) => fixture.typetext === "Premier League")
        .filter((fixture) => fixture.HomeName === "Manchester City")
        .map((fixture, index) => (
...
export default MenPremierLeagueHome;
